...
import 'changeprofile_model.dart';
export 'changeprofile_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> changeprofileUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final changeprofileUsersRecord = changeprofileUsersRecordList.isNotEmpty
            ? changeprofileUsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.yourEmailTextController1 ??=
                        ...
                        text: changeprofileUsersRecord?.email,
                      ),
                      ...
                      validator: _model.yourEmailTextController1Validator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.yourEmailTextController2 ??=
                          TextEditingController(
                        text: changeprofileUsersRecord?.displayName,
                      ),
                      ...
                      validator: _model.yourEmailTextController2Validator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.cityTextController1 ??=
                          TextEditingController(
                        text: changeprofileUsersRecord?.phoneNumber,
                      ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.cityTextController2 ??=
                          TextEditingController(
                        text: changeprofileUsersRecord?.password,
                      ),
                      focusNode: _model.cityFocusNode2,
                      textCapitalization: TextCapitalization.words,
                      obscureText: !_model.cityVisibility,
                      decoration: InputDecoration(
                        ...
                        suffixIcon: InkWell(
                          onTap: () => setState(
                            () =>
                                _model.cityVisibility = !_model.cityVisibility,
                          ),
                          focusNode: FocusNode(skipTraversal: true),
                          child: Icon(
                            _model.cityVisibility
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await changeprofileUsersRecord!.reference
                              .update(createUsersRecordData(
                            email: _model.yourEmailTextController1.text,
                            displayName: _model.yourEmailTextController2.text,
                            phoneNumber: _model.cityTextController1.text,
                            photoUrl: _model.myBioTextController.text,
                            password: _model.cityTextController2.text,
                          ));
                        },
                        text: 'Save Changes',

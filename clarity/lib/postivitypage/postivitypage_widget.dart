...
import 'postivitypage_model.dart';
export 'postivitypage_model.dart';

class PostivitypageWidget extends StatefulWidget {
  const PostivitypageWidget({super.key});

  @override
  State<PostivitypageWidget> createState() => _PostivitypageWidgetState();
}

class _PostivitypageWidgetState extends State<PostivitypageWidget> {
  late PostivitypageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostivitypageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> postivitypageUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final postivitypageUsersRecord = postivitypageUsersRecordList.isNotEmpty
            ? postivitypageUsersRecordList.first
            : null;
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        child: LikeWidget(
                                                          key: Key(
                                                              'Keytjy_${listViewIndex}_of_${listViewArticlesRecordList.length}'),
                                                        ),
                                                      ),
                                                    ),
                                                    Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: LikeWidget(
                                                      key: Key(
                                                          'Keyid0_${listViewIndex}_of_${listViewArticlesRecordList.length}'),
                                                      parameter1:
                                                          listViewArticlesRecord
                                                              .reference,
                                                    ),

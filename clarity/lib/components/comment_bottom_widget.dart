...
export 'comment_bottom_model.dart';

class CommentBottomWidget extends StatefulWidget {
  const CommentBottomWidget({
    super.key,
    this.commentparameter,
  });

  final ArticlesRecord? commentparameter;

  @override
  State<CommentBottomWidget> createState() => _CommentBottomWidgetState();
}

class _CommentBottomWidgetState extends State<CommentBottomWidget> {
  late CommentBottomModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CommentBottomModel());
                      ...
                      onPressed: () async {
                        await CommentsRecord.collection
                            ...
                            .set(createCommentsRecordData(
                              ...
                              articleType: widget.commentparameter?.reference,
                            ));
                      },
                    ),
                  ],

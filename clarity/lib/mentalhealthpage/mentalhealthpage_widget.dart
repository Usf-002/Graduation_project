...
import 'mentalhealthpage_model.dart';
export 'mentalhealthpage_model.dart';

class MentalhealthpageWidget extends StatefulWidget {
  const MentalhealthpageWidget({super.key});

  @override
  State<MentalhealthpageWidget> createState() => _MentalhealthpageWidgetState();
}

class _MentalhealthpageWidgetState extends State<MentalhealthpageWidget> {
  late MentalhealthpageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MentalhealthpageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> mentalhealthpageUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final mentalhealthpageUsersRecord =
            mentalhealthpageUsersRecordList.isNotEmpty
                ? mentalhealthpageUsersRecordList.first
                : null;
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          mentalhealthpageUsersRecord!.photoUrl,
                          width: 300.0,
                          height: 200.0,
                          fit: BoxFit.cover,
                        ),
              ...
              title: Text(
                mentalhealthpageUsersRecord.displayName,
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        child: LikeWidget(
                                                          key: Key(
                                                              'Keyybo_${listViewIndex}_of_${listViewArticlesRecordList.length}'),
                                                        ),
                                                      ),
                                                    ),
                                                    Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  InkWell(
                                                    ...
                                                    child: LikeWidget(
                                                      key: Key(
                                                          'Keyhx8_${listViewIndex}_of_${listViewArticlesRecordList.length}'),
                                                      parameter1:
                                                          listViewArticlesRecord
                                                              .reference,
                                                    ),

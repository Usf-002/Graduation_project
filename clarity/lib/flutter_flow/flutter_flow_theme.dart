...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF19747E);
  late Color secondary = const Color(0xFFCCD1AF);
  late Color tertiary = const Color(0xFFFEFAE0);
  late Color alternate = const Color(0xFFFAEDCD);
  late Color primaryText = const Color(0xFF71706E);
  late Color secondaryText = const Color(0xFF71706E);
  late Color primaryBackground = const Color(0xFFD1E8E2);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFA9D6E5);
  late Color accent2 = const Color(0xFFE1E6FF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xC37A854F);
  late Color secondary = const Color(0xFF7D8370);
  late Color tertiary = const Color(0xFF7F7B6D);
  late Color alternate = const Color(0xFF7D7569);
